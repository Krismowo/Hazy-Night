...
class FlxSound extends FlxBasic
{
	...
	public var actualpitch:Float = 1;
	...
	/*
	 * funny amonger thing for uh, something i think
	 */
	 ...
	 */
	@:isVar public var pitch(get, set):Float = 1;
	...
	public function set_pitch(v:Float):Float
	{
		...
		{
			if(playing)
				_channel.__source.__backend.setPitch(v);
		}
		actualpitch = v;
		//pitch = actualpitch;
		#end
